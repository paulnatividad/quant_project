...
ENUM_TIMEFRAMES dataTF[] = {PERIOD_M1, PERIOD_M15, PERIOD_H4, PERIOD_D1, PERIOD_W1}; // For Data Collection
...
class StructuredData{
  protected:
    ...
    double objmr_high;
    double objmr_low;
    double objcurrentCandleOpen;
    double objcurrentCandleClose;
  ...
  public:
    ...
    void RunOnTickPlotter(string stTrend, bool stChange, double stVal, bool is_barClosed, double atrValue){
      ...
      //Open and Close
      objcurrentCandleOpen = objopenValues[0];
      objcurrentCandleClose = objcloseValues[0];
      ...
      PlotStructure(
         ...
         string dataLine = StringFormat(
             "%s,%s,%s,%d,%d,%d,%f,%f,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f",
             ...
             objcurrentCandleOpen,                                 // Current candle open
             objcurrentCandleHigh,                                 // Current candle high
             objcurrentCandleLow,                                  // Current candle low
             objcurrentCandleClose,                                // Current candle close
         ...
         string datafileName = filesymbol + ".csv";
         
         // Write data to file
         //WriteDataToFile("au_market_data.csv", dataLine);
         WriteDataToFile(datafileName, dataLine);
         
         // Print the full path for debugging
         //string fileName = "au_market_data.csv";
         string fullPath = TerminalInfoString(TERMINAL_DATA_PATH) + "\\MQL5\\Files\\" + datafileName;
